        ...
        <div className='flex justify-between'>
            <div className="space-y-0.5">
                <h4 className='flex items-center gap-x-2'>
                    ...
                    {tolerancs !== undefined ?
                        <div className='ltr-dir h-5 text-xs/3 tracking-widest font-bold px-1 flex-center gap-1 rounded-full border border-solid border-orange-500 bg-orange-100 text-orange-700 dark:border-orange-400/80 dark:bg-orange-100/10 dark:text-orange-500 '>
                            {tolerancs} %
                        </div> : ""
                    }
                </h4>
