...
export default function Header() {
    ...
    return (
        <div className='header fixed z-10 top-0 right-0 left-0'>
            ...
            <div className={`${isShowMobileMenu ? "h-screen overflow-y-auto  pointer-events-auto" : "overflow-hidden h-0  pointer-events-none"} lg:hidden  transition-all   duration-700`}>
                <MobieMenu />
            </div>
