...
export default function TopbarSlimDarkDefault({ isFadeScroll, isLanguageFa ,navigationType}) {
    ...
    return (
        < >
            ...
            <div className={`topbar  transition ease-linear  flex-center border-b border-solid h-7 lg:h-7 bg-slate-800 border-slate-700
