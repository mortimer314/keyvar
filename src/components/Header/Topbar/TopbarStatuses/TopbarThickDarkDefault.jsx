...
export default function TopbarThickDarkDefault({ isFadeScroll, isLanguageFa ,navigationType}) {
  return (
    < >

            <div className={`topbar  transition ease-linear  flex-center border-b border-solid h-16 lg:h-16 bg-slate-800 border-slate-700
