...
export default function TopbarThickLightDarker({ isFadeScroll, isLanguageFa ,navigationType}) {
  return (
    
    <div className={`topbar  transition ease-linear  flex-center border-b border-solid h-16 lg:h-16 bg-slate-900 border-gray-700
