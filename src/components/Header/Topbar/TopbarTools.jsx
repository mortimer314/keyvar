        ...
        <>
            {
                !props.isSlim ?
                    <div className="w-10 h-10 md:w-12 md:h-12 overflow-hidden rounded-full cursor-pointer">
                        <img className='w-full' src="/assets/images/topbar-img.jpg" alt="" />
                    </div> :
            ...
            <div className="profile-card w-[290px] h-[475px] flex flex-col ">
                <div className="pt-6 pb-4 ">
                    <div className="w-12 h-12 rounded-full overflow-hidden flex-center m-auto border border-solid border-gray-300 dark:border-gray-500">
                        <img className='w-full h-full' src="/assets/images/topbar-img.jpg" alt="" />
                    </div>
...
function ToolDropdownContentSocialMedia(){
    return(
        <div className="w-[245px] h-[320px] overflow-auto  px-4 pt-4 ">
            ...
            <div className="">
                    <a href="#" className="">
                    <img src="/assets/images/social/figma.png"  alt="" />
                        <p className=''>Figma</p>
                    </a>
                </div>
                ...
                <div className="">
                    <a href="#" className="">
                    <img src="/assets/images/social/gitlab.png"  alt="" />
                        <p className=''>Gitlab</p>
                    </a>
                </div>
                <div className="">
                    <a href="#" className="">
                    <img src="/assets/images/social/trello.png"  alt="" />
                ...
                <div className="">
                    <a href="#" className="">
                    <img src="/assets/images/social/spotify.png"  alt="" />
                        <p className=''>Spotify</p>
                    </a>
                </div>
                <div className="">
                    <a href="#" className="">
                    <img src="/assets/images/social/behance.png" className=' ' alt="" />
                        <p className=''>Behance</p>
                    </a>
                </div>
                <div className="">
                    <a href="#" className="">
                    <img src="/assets/images/social/slack.png"  alt="" />
                        <p className=''>Slack</p>
                    </a>
                </div>
                <div className="">
                ...
                <div className="">
                    <a href="#" className="">
                    <img src="/assets/images/social/ln.png"  alt="" />
                        <p className=''>in</p>
                    </a>
                </div>
                <div className="">
                    <a href="#" className="">
                    <img src="/assets/images/social/google-photos.png"  alt="" />
                        <p className=''>Photos</p>
                    </a>
                </div>
                <div className="">
                    <a href="#" className="">
                    <img src="/assets/images/social/google-maps.png"  alt="" />
                        <p className=''>Maps</p>
                    </a>
                </div>
                <div className="">
                    <a href="#" className="">
                    <img src="/assets/images/social/google-drive.png"  alt="" />
                        <p className=''>Drive</p>
                    </a>
                </div>
                <div className="">
                    <a href="#" className="">
                    <img src="/assets/images/social/google-cloud.png"  alt="" />
                        <p className=''>Cloud</p>
                    </a>
                </div>
                ...
                <div className="">
                    <a href="#" className="">
                    <img src="/assets/images/social/bitbucket.png"  alt="" />
